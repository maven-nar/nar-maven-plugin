...
public class TestLibrarySet
  ...
  /**
   * The libs parameter should not end with .lib, .so, .a etc however the
   * previous test would cause a build exception for any library containing
   * periods. Now logs warning message.
   */
