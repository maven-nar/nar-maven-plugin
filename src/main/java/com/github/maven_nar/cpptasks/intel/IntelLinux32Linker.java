...
public final class IntelLinux32Linker extends AbstractLdLinker {
  ...
  private static final IntelLinux32Linker dllLinker = new IntelLinux32Linker("lib", ".so", false,
      new IntelLinux32Linker("lib", ".so", true, null));
  ...
  private IntelLinux32Linker(final String outputPrefix, final String outputSuffix, final boolean isLibtool,
      final IntelLinux32Linker libtoolLinker) {
    // FREEHEP
    super("icpc", "-V", objFiles, discardFiles, outputPrefix, outputSuffix, isLibtool, libtoolLinker);
  }
