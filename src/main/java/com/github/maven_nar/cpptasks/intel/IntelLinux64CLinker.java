...
public final class IntelLinux64CLinker extends AbstractLdLinker {
  ...
  private static final IntelLinux64CLinker dllLinker = new IntelLinux64CLinker("lib", ".so", false,
      new IntelLinux64CLinker("lib", ".so", true, null));
  ...
  private IntelLinux64CLinker(final String outputPrefix, final String outputSuffix, final boolean isLibtool,
      final IntelLinux64CLinker libtoolLinker) {
    super("ecc", "-V", objFiles, discardFiles, outputPrefix, outputSuffix, isLibtool, libtoolLinker);
  }
