...
/**
 * Test GNU Cobol compiler adapter
 * 
 */
// TODO Since GNUCobolCompiler extends GccCompatibleCCompiler, this test
// should probably extend TestGccCompatibleCCompiler.
public class TestGNUCobolCompiler extends TestCase {
  public TestGNUCobolCompiler(final String name) {
    super(name);
  }

  public void testBidcob() {
    final GNUCobolCompiler compiler = GNUCobolCompiler.getInstance();
    assertEquals(AbstractProcessor.DEFAULT_PROCESS_BID, compiler.bid("foo.cob"));
  }

  public void testBidcbl() {
    final GNUCobolCompiler compiler = GNUCobolCompiler.getInstance();
    assertEquals(AbstractProcessor.DEFAULT_PROCESS_BID, compiler.bid("foo.cbl"));
  }
